   ...
   $.ajax({
      ...
      Toast.fire({
         ...
         Toast.fire({
            ...
            if (result.value) {
               let idViaje = respuestaDecodificada.viaje.id_tours;
               let fechaInicioViaje = respuestaDecodificada.viaje.start;
               let fechaFinViaje = respuestaDecodificada.viaje.end;
               let titulo = respuestaDecodificada.viaje.nombreTours;
