                ...
                "dataSrc": function(json) {
                    ...
                    if (json.mantenimiento) {
                        for (let i = 0, ien = json.mantenimiento.length; i < ien; i++) {
                            ...
                            html += '        <button title="Editar" type="button" name="' + json.mantenimiento[i].id_mantenimiento + '" class="btn btn-primary" data-toggle="modal"';
                            html += '            data-target="#modal-editar">';
                            html += '            <i class="fas fa-edit" style="color: white"></i>';
                            html += '        </button>';
                            html += '        <button title="Reporte" type="button" name="' + json.mantenimiento[i].id_mantenimiento + '" class="btn btn-secondary" data-toggle="modal"';
                            html += '            data-target="#modal-reporte">';
                            html += '            <i class="fas fa-eye" style="color: white"></i>';
                            html += '        </button>';
                            html += '        <button title="Eliminar" type="button" name="' + json.mantenimiento[i].id_mantenimiento + '" class="btn btn-danger" data-toggle="modal"';
