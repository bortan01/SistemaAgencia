                ...
                "dataSrc": function(json) {
                    ...
                    if (json.viaje) {
                        for (let i = 0, ien = json.viaje.length; i < ien; i++) {
                            ...
                            html += '        <button title="Editar" type="button" name="' + json.viaje[i].idtipo_viaje + '" class="btn btn-primary" data-toggle="modal"';
                            html += '            data-target="#modal-editar">';
                            html += '            <i class="fas fa-edit" style="color: white"></i>';
                            html += '        </button>';
                            html += '        <button title="Eliminar" type="button" name="' + json.viaje[i].idtipo_viaje + '" class="btn btn-danger" data-toggle="modal"';
