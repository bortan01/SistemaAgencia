                ...
                "dataSrc": function(json) {
                    ...
                    if (json.clase) {
                        for (let i = 0, ien = json.clase.length; i < ien; i++) {
                            ...
                            html += '        <button title="Editar" type="button" name="' + json.clase[i].idclase + '" class="btn btn-primary" data-toggle="modal"';
                            html += '            data-target="#modal-editar">';
                            html += '            <i class="fas fa-edit" style="color: white"></i>';
                            html += '        </button>';
                            html += '        <button title="Eliminar" type="button" name="' + json.clase[i].idclase + '" class="btn btn-danger" data-toggle="modal"';
