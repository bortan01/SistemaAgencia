            ...
            "dataSrc": function (json) {
               ...
               if (json.contactos) {
                  for (let i = 0, ien = json.contactos.length; i < ien; i++) {
                     ...
                     html += '        <button title="Editar" type="button" name="' + json.contactos[i].id_contacto + '" class="btn btn-primary" data-toggle="modal"';
                     html += '            data-target="">';
                     html += '            <i class="fas fa-edit" style="color: white"></i>';
                     html += '        </button>';
                     html += '        <button title="Eliminar" type="button" name="' + json.contactos[i].id_contacto + '" class="btn btn-danger" data-toggle="modal"';
