                ...
                "dataSrc": function (json) {
                    ...
                    if (json.preguntas) {
                        for (let i = 0, ien = json.preguntas.length; i < ien; i++) {
                            ...
                            html += '        <button title="Editar" type="button" name="' + json.preguntas[i].id_pregunta+'" id="' + json.preguntas[i].id_rama+'" class="btn btn-primary" data-toggle="modal"';
                            html += '            data-target="#modal-editar">';
                            html += '            <i class="fas fa-edit" style="color: white"></i>';
                            html += '        </button>';
                            html += '        <button title="Eliminar" type="button" name="' + json.preguntas[i].id_pregunta+ '" class="btn btn-danger" data-toggle="modal"';
