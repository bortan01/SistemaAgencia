                        ...
                        <form id="informacion-form" name="register-form" onsubmit="return false">
                              ...
                              <div class="col-sm-12">
                                 <div class="form-group multiple-form-group input-group">
                                    ...
                                    <div class="input-group">
                                       <input type="text" class="form-control" name="titulo_actu" id="titulo_actu"
                           ...
                           <div class="row">
                              ...
                              <div class="col-sm-6">
                                 <!-- text input -->
                                 <div class="hidden">
                                    <label name="detalle" id="detalle">Registró un Actualización de
                                       envío</label>
                                 </div>
                              </div>
            ...
            <div class="modal-content">
               ...
               <div class="overlay-wrapper">
                  ...
                  <div class="modal-header">
                     <h4 class="modal-title">Historial de envío:</h4>
