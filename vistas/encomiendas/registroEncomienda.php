            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Registro de Encomienda</li>
                        <button class="button button-circle alert" data-toggle="modal" data-target="#modal-ayuda"
                            id="botonAyudaEncomienda"> <i class="fas fa-question"></i></button>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="overlay-wrapper">
                    <div id="loadingRegistroEncomienda" class="overlay"><i class="fas fa-3x fa-sync-alt fa-spin"></i>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group multiple-form-group input-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input class="form-control" type="text" name="cliente_des"
                                                            id="cliente_des" placeholder="Digite el nombre">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="direccion" id="direccion" type="text"
                                                        class="form-control" placeholder="Introduzca la Dirección">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input id="porcenaje" type="text" class="form-control"
                                                                disabled="true">
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <form id="comision-form" name="register-form" onsubmit="return false">
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>Comisión</label>
                                        <input name="comision" id="comisionActu" type="number" min=0 max=100
                                            class="form-control" placeholder="Introduzca la comision"
                                            autocomplete="off">
                                    </div>
                                </div>
                            </div>
