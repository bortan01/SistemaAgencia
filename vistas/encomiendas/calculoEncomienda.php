            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Cálculo de Encomienda</li>
                        <button class="button button-circle alert" data-toggle="modal" data-target="#modal-ayuda"
                            id="botonAyudaCalculoEncomienda"> <i class="fas fa-question"></i></button>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="overlay-wrapper">
                    <div id="loadingCalculoEncomienda" class="overlay"><i class="fas fa-3x fa-sync-alt fa-spin"></i>
