         ...
         <div class="row">
            <div class="col-md-12">
               <div class="overlay-wrapper">
                  <div id="loadingRegistroVehiculo" class="overlay"><i class="fas fa-3x fa-sync-alt fa-spin"></i>
                           ...
                           <div class="timeline-body">
                              <div class="row">
                                 ...
                                 <div class="col-sm-2">
                                    <div class="form-group">
                                       <label>Puertas</label>
                                       <input type="number" class="form-control" min=1 max=5 name="puertas" id="puertas"
                                          autocomplete="off">
                                    </div>
                                 </div>
                                 <div class="col-sm-6">
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-sm-5">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control" name="insertarOpc" id="insertarOpc"
                                 ...
                                 <div class="col-sm-1">
                                    ...
                                    <span class="input-group-btn">
                                       <button type="button" class="btn btn-success btn-add" name="agregarOpcion"
                                          id="agregarOpcion" style="margin-top:8px;"
                        ...
                        <div class="timeline-item">
                           ...
                           <div class="timeline-body">
                              ...
                              <div class="row">
                                 <div class="col-sm-12">
                                    <div class="form-group">
                                       <textarea class="form-control" rows="3" id="detalleVehiculo"
