            ...
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  ...
                  <button class="button button-circle alert" data-toggle="modal" data-target="#modal-ayuda"
                     id="botonAyudaVerMantenimientos"> <i class="fas fa-question"></i></button>
               </ol>
            </div>
         </div>
      </div><!-- /.container-fluid -->
                  ...
                  <div class="row">
                     ...
                     <div class="col-sm-6">
                        <div class="form-group">
                           ...
                           <div class="input-group">
                              <input type="text" class="form-control" id="piezas_cambiadasM" name="piezas_cambiadasM"
                                 autocomplete="off">
                           </div>
                           <!-- /.input group -->
                        </div>
   ...
   <div class="modal fade" id="modal-reporte">
      <div class="modal-dialog modal-lg modal-dialog-centered">
         <div class="modal-content">
            ...
            <div class="overlay-wrapper">
               <div id="loadingActualizar" class="overlay"><i class="fas fa-3x fa-sync-alt fa-spin"></i>
                  <div class="text-bold pt-2">Cargando...
                  </div>
               </div>
                                                   ...
                                                   <thead>
                                                      <tr>
                                                         <td>
                                                            <p> </p>
                                                            <label>Placa:</label>
                                                            <p name="placaMantenimiento" id="placaMantenimiento">
                                                            </p>

                                                         </td>
                                                         <td><label>Año:</label>
                                                            <p name="anioMantenimiento" id="anioMantenimiento">
                                                            </p>
                                                         </td>
                                                      </tr>
                                                      <tr>
                                                         <td>
                                                            <p> </p>
                                                            <label>Marca:</label>
                                                            <p name="marcaMantenimiento" id="marcaMantenimiento"></p>
                                                         </td>
                                                         <td><label>Modelo:</label>
                                                            <p name="modeloMantenimiento" id="modeloMantenimiento"></p>
                                                         </td>
                                                      </tr>
                                                   </thead>
                                                </table>
                                       ...
                                       <tbody id="detalle_productos">
                                          <tr>
                                             <td class="textcenter"><label name="fechaMantenimiento"
                                                   id="fechaMantenimiento" style="font-weight: normal;"></label></td>
                                             <td class="textcenter"><label name="lugarMantenimiento"
                                                   id="lugarMantenimiento" style="font-weight: normal;"></label></td>
                                          </tr>
                                       </tbody>
                                    </table>
                                    <table id="factura_detalle">
                                       ...
                                       <tbody id="detalle_productos">
                                          <tr>
                                             <td class="textcenter"><label name="mantenimientosRealizados"
                                                   id="mantenimientosRealizados" style="font-weight: normal;"></label>
                                             </td>

                                             <td class="textcenter"><label name="piezasMantenimiento"
                                                   id="piezasMantenimiento" style="font-weight: normal;"></label>
                                             </td>
                                          </tr>
                                       </tbody>
                                    </table>
