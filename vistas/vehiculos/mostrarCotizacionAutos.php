                  ...
                  <div class="row">
                     ...
                     <div class="col-sm-3">
                        <div class="form-group">
                           ...
                           <div class="input-group">
                              <input id="nombreVehiculo" name="nombreVehiculo" type="text" class="form-control"
                                 disabled>
                           </div>
                           <!-- /.input group -->
                        </div>
                     ...
                     <div class="col-sm-6">
                        <div class="form-group">
                           ...
                           <div class="input-group">
                              <input id="direccion_recogida" name="direccion_recogida" type="text" class="form-control">
                           </div>
                           <!-- /.input group -->
                        </div>
                     </div>
                     ...
                     <div class="col-sm-3">
                        <div class="form-group">
                           <label>Fecha</label>
                           <div class="input-group">
                              <input id="fechaDevolucion" name="fechaDevolucion" type="text" class="form-control"
                                 disabled>
                           </div>
                           <!-- /.input group -->
                        </div>
                     ...
                     <div class="col-sm-3">
                        <div class="form-group">
                           ...
                           <div class="input-group clockpicker" data-autoclose="true">
                              <input type="text" id="HoraDevolucion" name="HoraDevolucion" class="form-control"
                                 value="08:00" />
                           </div>
                        </div>
                     </div>
