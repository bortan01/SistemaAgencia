            ...
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  ...
                  <button class="button button-circle alert" data-toggle="modal" data-target="#modal-ayuda"
                     id="botonAyudaPreguntasCerradas"> <i class="fas fa-question"></i></button>
               </ol>
            </div>
         </div>
      </div><!-- /.container-fluid -->
                  ...
                  <div class="row">
                     ...
                     <div class="col-sm-10">
                        <div class="form-group">
                           ...
                           <div class="input-group">
                              <select class="select2" name="opcion_respuesta[]" id="combo_cerrada" multiple="multiple"
                                 data-placeholder="Seleccione" style="width:100%;" aria-hidden="true">
               ...
               <div class="row">
                  <div class="col-sm-12">
                     <div class="form-group">
                        ...
                        <div class="input-group">
                           <input id="opcion_combo" name="opcion_combo" type="text" class="form-control"
                              autocomplete="off" placeholder="Digite la opción">
                        </div>
                        <!-- /.input group -->
                     </div>
                  </div>
