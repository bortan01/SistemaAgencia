            ...
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  ...
                  <button class="button button-circle alert" data-toggle="modal" data-target="#modal-ayuda"
                     id="botonAyudaServicios"> <i class="fas fa-question"></i></button>
               </ol>
            </div>
         </div>
      </div><!-- /.container-fluid -->
                              ...
                              <div class="row" id="configuracionAsientos">
                                 <div class="col-sm-3">
                                    <div class="form-group">
                                       ...
                                       <div class="input-group">
                                          <input id="numero_filas" name="numero_filas" type="number" min="1" value="2"
                                 ...
                                 <div class="col-sm-3">
                                    <div class="form-group">
                                       ...
                                       <div class="input-group">
                                          <input id="asientos_derecho" name="asientos_derecho" type="number" min="1"
                                 ...
                                 <div class="col-sm-3">
                                    <div class="form-group">
                                       ...
                                       <div class="input-group">
                                          <input id="asientos_izquierdo" name="asientos_izquierdo" type="number" min="1"
                                             value="2" step="1" class="form-control">
                                       </div>
                                    </div>
                                 </div>
