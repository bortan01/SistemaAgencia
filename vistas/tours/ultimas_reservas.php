         ...
         <div class="row mb-2">
            ...
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active">Ultimas Reservas</li>
         ...
         <div class="col-12">
            <div class="card">
               <div class="card-header">
                  <h3 class="card-title">Ultimas Reservas</h3>
               </div>
               <!-- /.card-header -->
               <div class="card-body">
...
<script src="<?= $base_url ?>js/controladores/turs/ultimas_reservas.js"></script>
