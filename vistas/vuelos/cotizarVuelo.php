                    ...
                    <div class="overlay-wrapper">
                        ...
                        <div class="timeline">
                            ...
                            <div>
                                ...
                                <div class="timeline-item">
                                    <h3 class="timeline-header"><a href="#">Datos de Vuelos (Ida)</a></h3>
                                    <div class="timeline-body">
                                        <div class="row">
                            ...
                            <div>
                                ...
                                <div class="timeline-item">
                                    ...
                                    <h3 class="timeline-header"><a class="add-margin" href="#">Datos de Vuelos (Retorno)</a> 
                                    <input 
                                            name="chec" type="checkbox" id="chec" onChange="comprobar(this);" />
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="ciudad_llegada"
                                                        id="ciudad_llegada" readonly style="display:none"
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control" name="fechaLlegada"
                                                        id="fechaLlegada" readonly style="display:none">
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                ...
                                                <div class="input-group clockpicker" data-autoclose="true">
                                                    <input type="text" id="timepicker2" name="start"
                                                        class="form-control" value="08:00" readonly style="display:none" />
                                                </div>
                                            </div>
                                        </div>
...
function comprobar(obj) {
    if (obj.checked) {
        ...
        document.getElementById('ciudad_llegada').style.display = "";
        document.getElementById('fechaLlegada').style.display = "";
        document.getElementById('timepicker2').style.display = "";
    } else {

        document.getElementById('ciudad_llegada').style.display = "none";
        document.getElementById('fechaLlegada').style.display = "none";
        document.getElementById('timepicker2').style.display = "none";
    }
}
</script>
<!-- jquery-validation -->
