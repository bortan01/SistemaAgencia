                           ...
                           <div class="row">
                              ...
                              <div class="col-sm-6">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="ciudad_partida" id="ciudad_partida"
                              ...
                              <div class="col-sm-6">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="ciudad_llegada" id="ciudad_llegada"
                                       placeholder="Digite nombre del Lugar">
                                 </div>
                              </div>
                              <div class="col-sm-3">
                        ...
                        <div class="timeline-body">
                           <div class="row">
                              ...
                              <div class="col-sm-1">
                                 ...
                                 <span class="input-group-btn">
                                    <button type="button" class="btn btn-success btn-add" data-toggle="modal"
                                       data-target="#modal-aerolinea" style="margin-top: 10px; width: 100%;">+</button>
                                 </span>
                              </div>
                              <div class="col-sm-3">
                                 <!-- select -->
                              ...
                              <div class="col-sm-1">
                                 ...
                                 <span class="input-group-btn">
                                    <button type="button" class="btn btn-success btn-add" data-toggle="modal"
                                       data-target="#modal-tipoClase" style="margin-top: 10px; width: 100%;">+</button>
                                 </span>
                              </div>
                              <div class="col-sm-3">
                                 <!-- select -->
                              ...
                              <div class="col-sm-1">
                                 ...
                                 <span class="input-group-btn">
                                    <button type="button" class="btn btn-success btn-add" data-toggle="modal"
                                       data-target="#modal-tipoViaje" style="margin-top: 10px; width: 100%;">+</button>
                                 </span>
                              </div>
                              ...
                              <div class="col-sm-4">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="insertarOpcion" id="insertarOpcion"
                  ...
                  <div>
                     ...
                     <div class="timeline-item">
                        ...
                        <div class="timeline-footer" style="text-align: right;">
                           <button name="btnGuardarCotizacion" id="btnGuardarCotizacion" class="btn btn-info btn-sm"
