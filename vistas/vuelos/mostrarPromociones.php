                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <button class="button button-circle alert" data-toggle="modal" data-target="#modal-ayuda"
                            id="botonAyudaMostrarPromociones"> <i class="fas fa-question"></i></button>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input id="aerolineaPromocion" name="aerolineaPromocion" type="text"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input id="promocion" name="promocion" type="text" class="form-control"
                                            disabled>
                                    </div>
                                    <!-- /.input group -->
                                </div>
