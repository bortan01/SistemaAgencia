                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <button class="button button-circle alert" data-toggle="modal" data-target="#modal-ayuda"
                            id="botonAyudaRegistroPromocion"> <i class="fas fa-question"></i></button>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="nombrePromocion"
                                                        id="nombrePromocion"
                                                        placeholder="Digite nombre de la Promoción">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <!-- text input -->
...
<script src="<?= $base_url?>js/controladores/vuelos/clases-app.js"></script>
