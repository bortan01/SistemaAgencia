                    ...
                    <div class="card-header">
                        ...
                        <div class="timeline-footer" style="text-align: right;">
                            <a class="btn btn-info btn-sm" style="color: white" data-toggle="modal"
                                data-target="#modal-tipoClase">Nueva Clase</a>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <div id="" class="dataTables_wrapper dt-bootstrap4">
                            <div class="row">
                                <div class="col-sm-12">
                                    <table id="tabla_tiposClases" class="table table-bordered table-striped">
            ...
            <div class="modal-content">
                ...
                <div class="overlay-wrapper">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title">Modificar Tipo de Clase</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nombre_clase" id="nombre_clase" class="form-control"
                                        placeholder="Digite nombre de clase">
                                </div>
                            </div>
