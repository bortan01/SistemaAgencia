            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Aerolíneas Registradas</li>
                        <button class="button button-circle alert" data-toggle="modal" data-target="#modal-ayuda"
                            id="botonAyudaMostrarAerolineas"> <i class="fas fa-question"></i></button>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input id="telefonoContacto" name="telefonoContacto" type="text"
                                            class="form-control" data-inputmask="'mask': '(+999)9999 9999'"
                                            autocomplete="off">
                                    </div>
                                    <!-- /.input group -->
                                </div>
