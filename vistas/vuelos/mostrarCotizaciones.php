                  ...
                  <div class="row">
                     ...
                     <div class="col-sm-6">
                        <div class="form-group">
                           ...
                           <div class="input-group">
                              <input id="ciudad_partida" name="ciudad_partida" type="text" class="form-control"
                                 disabled>
                           </div>
                           <!-- /.input group -->
                        </div>
                     ...
                     <div class="col-sm-3">
                        <div class="form-group">
                           <label>Fecha</label>
                           <div class="input-group">
                              <input id="fechaPartida" type="text" name="fechaPartida" class="form-control" disabled>
                           </div>
                           <!-- /.input group -->
                        </div>
                     </div>
                     <div class="col-sm-3">
                        <div class="form-group">
                           <label>Hora</label>
                           <div class="input-group">
                              <input id="HoraPartida" name="HoraPartida" type="text" class="form-control" disabled>
                           </div>
                           <!-- /.input group -->
                        </div>
                     </div>
                     <div class="col-sm-12">
                        <div class="form-group">
                           ...
                           <div class="input-group">
                              <input id="ciudad_destino" name="ciudad_destino" type="text" class="form-control"
                                 disabled>
                           </div>
                           <!-- /.input group -->
                        </div>
                     ...
                     <div class="col-sm-6">
                        <div class="form-group">
                           ...
                           <div class="input-group">
                              <input id="ciudad_llegada" name="ciudad_llegada" type="text" class="form-control"
                                 disabled>
                           </div>
                           <!-- /.input group -->
                        </div>
                     ...
                     <div class="col-sm-3">
                        <div class="form-group">
                           <label>Fecha </label>
                           <div class="input-group">
                              <input id="fechaLlegada" type="text" name="fechaLlegada" class="form-control" disabled>
                           </div>
                           <!-- /.input group -->
                        </div>
                     </div>
                     <div class="col-sm-3">
                        <div class="form-group">
                           <label>Hora</label>
                           <div class="input-group">
                              <input id="HoraLlegada" name="HoraLlegada" type="text" class="form-control" disabled>
                           </div>
                           <!-- /.input group -->
                        </div>
                     </div>
                     ...
                     <div class="col-sm-4">
                        <div class="form-group">
                           ...
                           <div class="input-group">
                              <input id="nombre_aerolinea" name="nombre_aerolinea" type="text" class="form-control"
                                 disabled>
                           </div>
                           <!-- /.input group -->
                        </div>
                     ...
                     <div class="col-sm-4">
                        <div class="form-group">
                           ...
                           <div class="input-group">
                              <input id="nombre_clase" name="nombre_clase" type="text" class="form-control" disabled>
                           </div>
                           <!-- /.input group -->
                        </div>
                     </div>
                     <div class="col-sm-4">
                        <div class="form-group">
                           ...
                           <div class="input-group">
                              <input id="nombre_tipoviaje" name="nombre_tipoviaje" type="text" class="form-control"
                                 disabled>
                           </div>
                           <!-- /.input group -->
                        </div>
                     ...
                     <div class="col-sm-12">
                        <div class="form-group">
                           ...
                           <div class="input-group">
                              <input id="opc_avanzadas" name="opc_avanzadas" type="text" class="form-control" disabled>
                           </div>
                           <!-- /.input group -->
                        </div>
                     </div>
                                 ...
                                 <div id="page_pdf">
                                    ...
                                    <table id="factura_detalle">
                                       ...
                                       <tbody id="detalle_productos">
                                          ...
                                          <tr>
                                             <td class="textcenter"><label name="aerolinea" id="aerolinea"
                                                   style="font-weight: normal;"></label>
                                             </td>
                                             <td class="textcenter"><label name="clase" id="clase"
                                                   style="font-weight: normal;"></label></td>
                                             <td class="textcenter"><label name="tipoviaje" id="tipoviaje"
                                                   style="font-weight: normal;"></label>
                                             </td>
