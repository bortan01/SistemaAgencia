...
<div class="content-wrapper" style="min-height: 1185.73px;">
   ...
   <section class="content-header">
      <div class="container-fluid">
         <div class="row mb-2">
            <div class="col-sm-6">
               <h1 id="titulo">Publicar Tour Aéreo</h1>
            </div>
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="../../home.php">Inicio</a></li>
                  <li class="breadcrumb-item active">Publicar Tour Aéreo</li>
            ...
            <div class="col-md-12">
               <div class="overlay-wrapper">
                  ...
                  <div class="timeline">
                     ...
                     <!-- timeline item -->
                     <div>
                        <i class="fas fa-map-pin bg-green"></i>
                        <div class="timeline-item">
                           <h3 class="timeline-header no-border">
                     ...
                     <!-- timeline item -->
                     <div>
                        <i class="fas fa-calculator bg-yellow"></i>
                        <div class="timeline-item">
                           <h3 class="timeline-header no-border">
                     ...
                     <!-- END timeline item -->
                     <div>
                        <i class="fas fa-hand-holding-usd bg-navy blue"></i>
                        <div class="timeline-item">
                           <h3 class="timeline-header no-border">
