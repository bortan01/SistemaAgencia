...
<div class="content-wrapper" style="min-height: 1185.73px;">
   ...
   <section class="content-header">
      <div class="container-fluid">
         <div class="row mb-2">
            <div class="col-sm-10">
               <h1 id="titulo">Reservar Tour Aéreo</h1>
            </div>
            <div class="col-sm-2">
               <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                  <li class="breadcrumb-item active">Registrar Tour Aéreo</li>
               </ol>
            </div>
         </div>
      </div><!-- /.container-fluid -->
                  ...
                  <div>
                     ...
                     <div class="timeline-item">
                        ...
                        <div class="col-sm-6">
                           <!-- text input -->
                           <div class="hidden">
                              <label name="detalle" id="detalle">Registró Reserva de Paquete</label>
                           </div>
                        </div>
